...
public abstract class Form6Dao implements BaseDao<Form6> {
    ...
    @Query("SELECT * FROM Form6 WHERE districtCode = :districtCode AND scrId = :checkId AND synced = '1'")
    ...
    @Query("SELECT * FROM Form6 WHERE districtCode = :districtCode AND scrId = :scrId")
    public abstract Form6 getDataByScrId(String districtCode, String scrId);
